...
export const badgeColor = [
  ...
  "bg-emerald-300/50 border-emerald-400 text-emerald-950 dark:bg-emerald-950 dark:border-emerald-900 dark:text-emerald-100",
  ...
  "bg-fuchsia-300/50 border-fuchsia-400 text-fuchsia-950 dark:bg-fuchsia-950 dark:border-fuchsia-900 dark:text-fuchsia-100",

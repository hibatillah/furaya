...
class GeographyRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            'code' => ['required', 'string', 'max:5', Rule::unique("geographies", "code")->ignore($id)],
            'name' => ['required', 'string', 'max:255', Rule::unique("geographies", "name")->ignore($id)],
